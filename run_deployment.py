...
def run_main(stop_service: bool):
    """Run the fake news detector deployment pipeline"""
    model_name = "fake_news_detector"  # Updated model name to match your project
    ...
    # Get the tracking URI and properly format it for the command
    tracking_uri = get_tracking_uri()
    # Handle spaces in the path by ensuring it's properly quoted in the command
    formatted_uri = tracking_uri.replace(" ", "\\ ")
